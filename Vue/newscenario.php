	...
	<div class="module3">
		<div class="module form-block">
			<a href="index.php?page=accueil">
				<h2>Pour voir vos scénarios, cliquez ici</h2>
			</a>
		...
		<?php
			...
			<form method="post">
				...
				<input type="date" name="date_debut" placeholder="jj/mm/aaaa"><br> <input
					type="time" name="heure_debut" placeholder="hh:mm">
			...
			<?php
					...
					?>
			<form id="" method="post">
				<h2>Chosissez le jour de début :</h2>
				<br> <select name='date_debut' style='position: relative'>
				...
				</select><br> <input type="time" name="heure_debut"
					placeholder="hh:mm"><br>
				<h2>Chosissez le jour de fin :</h2>
				<br> <select name='date_fin' style='position: relative'>
					<option value="Lundi">Lundi</option>
					<option value="Mardi">Mardi</option>
					<option value="Mercredi">Mercredi</option>
					<option value="Jeudi">Jeudi</option>
		...
		<h2>Ce scénario doit-il être récurent ?</h2>
			<form id="myform2" method="post">
				<select name='recurrence' style='position: relative'
					onchange="change2()">
					<option value="rien">--</option>
		...
		<form method="post">
					...
					<input type="text" name="nom" placeholder="Nom"> <input
						type="submit" name="valid_nom" value="Valider">
				</form>
		...
		<br>
				...
				<form method="post"
					action="Controleur/annul_scenar.php?page=scenarios">
