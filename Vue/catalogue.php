...
<div class="module3">
	...
	<h1>Bienvenue sur la page d'achats</h1>
		<button onclick='document.location.href="index.php?page=cmdclient" '>Voir
	...
	<form method="post" action="index.php?page=panier">
			<input type="submit" name='commander' value="Voir le panier"><br>
			<br>
		</form>
...
<p>Sélectionnez une catégorie</p>
		<form action="" method="post" id="categ">
			<select id="cat" name="cat"
				onchange='document.getElementById("categ").submit()'>
