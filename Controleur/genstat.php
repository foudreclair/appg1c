...
for ($i=0; $i < 50; $i++) { 
	...
	$rand1 = rand(15,25);
	$mysqli ->query("INSERT INTO `bdd`.`Statistiques` (`Id`, `Date`, `Type`, `Valeur`, `Id_Capteur`) VALUES (NULL, '$date', 'Degré', '$rand1', '3')");
	$rand2 = rand(5,125);
	$mysqli ->query("INSERT INTO `bdd`.`Statistiques` (`Id`, `Date`, `Type`, `Valeur`, `Id_Capteur`) VALUES (NULL, '$date', 'Lux', '$rand2', '7')");
	$rand3 = rand(15,25);
	$mysqli ->query("INSERT INTO `bdd`.`Statistiques` (`Id`, `Date`, `Type`, `Valeur`, `Id_Capteur`) VALUES (NULL, '$date', 'Degré', '$rand3', '40')");
	$rand4 = rand(15,25);
	...
	$rand8 = rand(30,80);
	$mysqli ->query("INSERT INTO `bdd`.`Statistiques` (`Id`, `Date`, `Type`, `Valeur`, `Id_Capteur`) VALUES (NULL, '$date', '%', '$rand8', '47')");
	sleep(1);
}
